...
def test_local_path_dbfs_volume_prefix():
    assert (
        pipeline._local_path("dbfs:/Volumes/main/blf_dev/signals/docs/x.pdf")
        == "/Volumes/main/blf_dev/signals/docs/x.pdf"
    )
...
def test_local_path_already_local():
    assert (
        pipeline._local_path("/Volumes/main/blf_dev/signals/docs/x.pdf") == "/Volumes/main/blf_dev/signals/docs/x.pdf"
    )
