...
def _stores() -> list:
    return [
        ...
        html.Div(id="tree-folder-sync-sink", style={"display": "none"}),
...
def _upload_title() -> html.Div:
    return html.Div(
        style={"display": "flex", "alignItems": "center", "flex": "1"},
        children=[
            html.Span("Upload Files", style={"fontWeight": "bold", "color": _ACCENT, "fontSize": "16px", "flex": "1"}),
            dbc.Button(
                "×",
                id="upload-close-btn",
                size="sm",
                color="danger",
                outline=True,
                style={"fontSize": "16px", "padding": "2px 7px", "lineHeight": "1"},
            ),
        ],
    )
...
def _upload_modal() -> dbc.Modal:
    return dbc.Modal(
        ...
        size="lg",
        children=[
            dbc.ModalHeader(_upload_title(), close_button=False),
            dbc.ModalBody(
                html.Div(
